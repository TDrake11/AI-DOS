...
Baseline Markdown ban đầu nằm giữa Level 0 và Level 1. Sau Phase 2, AI-DOS đạt nền tảng Level 2 với manifest, contract/state validation, conformance, evidence và projections; adapter governance vẫn thuộc Phase 3+. Mục tiêu dài hạn là Level 4 trước khi tối ưu cho Level 5.
